...
public class IntegerEx {
	...
	public static void main(String[] args) {
		...
		System.out.println( Integer.toBinaryString(28) );	// 정수 	-> 이진수
		System.out.println( Integer.bitCount(28) );			// 이진수 -> 1비트의 갯수 
		...
		System.out.println("기본 타입 정수 int : " + value);
		}
