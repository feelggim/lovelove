...
public class Main {
	...
	public static void main(String[] args) {
		BoardAccess boardInterface = new BoardAccess();
		...
		do {
			...
			case 4:		// 게시글 수정
						...
						Board updDatedBoard = new Board(updateTitle,updateWriter,updateContent);
						updDatedBoard.setNo(updateNo);		// 게시글 번호 지정
						int result = boardInterface.update(updDatedBoard);
						if ( result > 0 ) {
